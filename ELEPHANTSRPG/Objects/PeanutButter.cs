...
{
    public class PeanutButter : WorldObject
    {
        ...
        public PeanutButter(Vector2 position, Player player)
        {
            Position = position;
        ...
        {
            texture = content.Load<Texture2D>("Sprites/PeanutButter");
        }
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            {
                _collected = true;
                if(_player.TotalNumOfPeanuts < 10) _player.TotalNumOfPeanuts++;
                _player.CurrentPeanut = _player.TotalNumOfPeanuts;
            }
        }
